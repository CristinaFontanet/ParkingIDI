...
public class BD extends SQLiteOpenHelper {
    ...
    private static final String STATISTICS_TABLE_CREATE_Historial = "CREATE TABLE " + Historial_TABLE_NAME + " (matricula TEXT, entryDay TIMESTAMP , exitDay TIMESTAMP , PRIMARY KEY(matricula,entryDay) )";
